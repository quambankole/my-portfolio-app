...
<main className="overscroll-contain  bg-black">
    ...
    <div className="flex flex-col items-start space-y-3 max-w-screen-lg w-full lg:w-[50vw] mx-auto px-6">
        <motion.h1
        id="about-heading"
        className="lg:text-7xl indent-4 lg:my-8 md:text-5xl font-bold uppercase text-white mb-1 border-l-1 border-green-400 pl-2"
        ...
        <div className="space-y-3 my-3">
            ...
            <div className="grid lg:grid-cols-2 text-lg text-left gap-2">
                {[
                { label: "Front‑End:", list: "Javascript(ES6+), Next.Js, React, TypeScript" },
